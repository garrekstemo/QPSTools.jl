...
spec_center = load_raman(joinpath(PROJECT_ROOT, "data", "raman", "MoSe2", "MoSe2-center.csv");
    material="MoSe2", sample="center")
spec_edge = load_raman(joinpath(PROJECT_ROOT, "data", "raman", "MoSe2", "MoSe2-right.csv");
    material="MoSe2", sample="right")
...
img_center = load(joinpath(PROJECT_ROOT, "data", "raman", "MoSe2", "MoSe2_x100_center.PNG"))
img_right = load(joinpath(PROJECT_ROOT, "data", "raman", "MoSe2", "MoSe2_x100_right.PNG"))
