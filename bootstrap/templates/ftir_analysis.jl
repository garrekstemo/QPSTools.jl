...
#   ターミナル / Terminal:  julia --project=. analysis/NH4SCN_CN_stretch/analysis.jl
#   REPL:                  include("analysis/NH4SCN_CN_stretch/analysis.jl")
...
# サンプルデータ / Sample data: "data/ftir/1.0M_NH4SCN_DMF.csv"
