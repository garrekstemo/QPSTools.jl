...
```
  ...
  │                                                                 │
  │  cp templates/explore_plmap.jl explore/sample_Aを見る.jl          │
  └───────────────────────────┬─────────────────────────────────────┘
                              │
                     面白い結果が見つかった？
                              │
...
- テンプレートをコピー：`cp templates/explore_plmap.jl explore/my_idea.jl`
...
- テンプレートをコピー：`cp templates/plmap_analysis.jl analysis/MoSe2_A1g/analysis.jl`
- データパスと解析パラメータを編集
...
QPSToolsはラボ統合層です。よく使う関数は兄弟パッケージにあります：
...
オープンソースの電子実験ノートです。QPSTools（ElabFTW.jl経由）で
以下のことが可能です：
